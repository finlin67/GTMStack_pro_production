...
Generated: 2026-04-10T15:25:19.994Z
...
- Still needs work: 0 active items still show weak placeholder patterns (small assets and/or generic summaries).
- Still needs work: 0 active items show extreme thumbnail aspect ratios that can cause visual fit issues.

## Failure Breakdown
- missing thumbnail: 0
- placeholder thumbnail: 0
...
- Active visible items: 116 of 120.
...
|---|---|---|---|
| systems-operations-hero-component-v2 | visible-meaningful | ok-iframe-entry-html | no major issue detected |
| revenue-systems-data-flow-v2 | visible-meaningful | ok-iframe-entry-html | no major issue detected |
| pipeline-command-center-v2 | visible-meaningful | ok-live-component | no major issue detected |
...
| edtech-compact-roi-funnel-v3 | visible-meaningful | ok-iframe-entry-html | no major issue detected |
| executive-logistics-dashboard-v3 | visible-meaningful | ok-live-component | no major issue detected |
| abm-pipeline-strategy-dashboard-v2 | visible-meaningful | ok-live-component | no major issue detected |
| social-media-marketing-hero-tile-v2 | visible-meaningful | ok-iframe-entry-html | no major issue detected |
| manufacturinghero-dashboard-tile-v2 | visible-meaningful | ok-live-component | no major issue detected |
...
| growthcore-component-extraction-v2 | visible-meaningful | ok-iframe-entry-html | no major issue detected |
...
| abm-campaign-radar-analysis-v2 | visible-meaningful | ok-live-component | no major issue detected |
| abm-flow-premium-tile-v2 | visible-meaningful | ok-live-component | no major issue detected |

...
export interface IndustriesMainTemplateProps {
  pageTitle?: string
  theme?: 'dark' | 'light'
  heroVisualId?: string
...
export default function IndustriesMainTemplate({ content }: IndustriesMainTemplateProps) {
  ...
  const industryItems = content?.industryItems ?? []
        ...
        <div className="container-width relative z-10">
          <div className="grid lg:grid-cols-[1.15fr_1fr] gap-10 lg:gap-16 items-center">
            <div className="space-y-6">
              ...
              >
                Industries where GTMstack xyz has delivered{' '}

      ...
      <section className="py-24 lg:py-40 px-6 bg-white text-center">
        <div className="max-w-4xl mx-auto">
          ...
          <h2 className="text-4xl lg:text-6xl font-black text-slate-900 leading-[1.1] tracking-tight">
            Industry expertise isn't a checkbox ΓÇö it's the <span className="text-transparent bg-clip-text bg-gradient-to-r from-indigo-500 to-cyan-500">foundation of signal.</span>
          </h2>

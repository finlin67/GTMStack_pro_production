...
function isContentEngagementTemplateContent(c: unknown): c is TemplateContent {
  return (
    !!c &&
    typeof c === 'object' &&
    'disciplinesItems' in c &&
    Array.isArray((c as TemplateContent).disciplinesItems)
  );
}
  ...
  return (
    <div className="font-['Inter',_sans-serif] antialiased bg-[#0F172A] text-white overflow-x-hidden">
      ...
      <footer className="bg-[#0B1120] py-8 border-t border-slate-800">
        <div className="container-width flex flex-col md:flex-row justify-between items-center text-slate-400 text-xs font-medium">

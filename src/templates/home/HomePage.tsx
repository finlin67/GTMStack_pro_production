      ...
      <div className="container-width relative z-10 py-12 md:py-16 lg:py-20">
        <div className="grid gap-8 lg:grid-cols-[1.1fr_0.9fr] lg:gap-10 items-center">
          <div className="space-y-5 md:space-y-6">
            <div className="inline-flex items-center gap-3 rounded-full border border-white/10 bg-white/[0.04] px-4 py-2 text-[11px] font-semibold uppercase tracking-[0.22em] text-cyan-100">
            ...
            <div className="space-y-3 md:space-y-4">
              <h1 className="font-display text-[2.6rem] font-semibold leading-[0.98] tracking-tight md:text-[4.1rem]">
                <span className="text-white">{content.hero.titleStart}</span>
                <span className="text-gradient">{content.hero.titleGradient}</span>
              </h1>
              <p className="max-w-xl text-[15px] leading-8 text-slate-300/90 md:text-[1.05rem]">
      ...
      <div className="container-width py-8 md:py-10">
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
          {content.stats.map((stat, index) => (
            <div
              key={index}
              className="glass-card-surface-alt flex h-full flex-col p-5 md:p-6"
            >
      ...
      <div className="container-width relative z-10 py-12 md:py-16">
        <div className="flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between md:gap-8">
          <div className="max-w-2xl">
            ...
            <h2 className="mt-4 font-display text-3xl font-semibold leading-[1.02] md:text-5xl">{content.methodology.title}</h2>
            <p className="mt-4 text-[15px] leading-8 text-slate-300/90 md:text-[1.05rem]">{content.methodology.description}</p>
          </div>
        ...
        <div className="mt-8 grid gap-6 md:mt-10 md:grid-cols-2">
          {content.methodology.steps.map((step) => (
            <div
              key={step.number}
              className="border-gradient rounded-[1.6rem] bg-white/[0.04] p-6 backdrop-blur md:p-7"
            >
              ...
              <p className="mt-4 text-[15px] leading-7 text-slate-300/88">{step.description}</p>
      ...
      <div className="container-width py-12 md:py-16">
        <div className="flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
          <div>
            ...
            <h2 className="mt-4 font-display text-3xl font-semibold leading-tight md:text-4xl">{content.expertise.title}</h2>
          </div>
        ...
        <div className="mt-8 grid gap-6 md:grid-cols-2">
          {content.expertise.items.map((item, index) => (
            <div
              key={index}
              className="group flex h-full flex-col rounded-[1.6rem] border border-white/10 bg-[linear-gradient(180deg,rgba(15,23,42,0.92),rgba(9,16,32,0.96))] p-6 shadow-[0_20px_50px_rgba(2,6,23,0.18)] transition-all duration-300 hover:-translate-y-1 hover:border-cyan-300/20 hover:shadow-[0_28px_68px_rgba(8,145,178,0.14)] md:p-7"
            >
              <div className="flex items-start justify-between gap-6">
                ...
                <ArrowRight className="h-5 w-5 text-slate-500 opacity-0 transition-all duration-300 group-hover:translate-x-1 group-hover:opacity-100" />
              </div>
              <p className="mt-4 flex-grow text-[15px] leading-7 text-slate-300/88">{item.description}</p>
              <div className="mt-5 flex flex-wrap gap-2">
                {item.tags.map((tag) => (
                  <span
                    key={tag}
                    className="rounded-full border border-white/10 bg-white/[0.06] px-3 py-1 text-xs font-semibold uppercase tracking-[0.18em] text-slate-300"
                  >
                    {tag}
                  </span>
                ))}
    ...
    <section className="relative overflow-hidden bg-slate-950 text-white">
      ...
      <div className="container-width relative z-10 py-12 md:py-16">
        <div className="max-w-4xl">
          ...
          <blockquote className="mt-4 font-display text-2xl font-semibold leading-tight md:text-4xl">
            {content.quote.text}
      ...
      <div className="container-width py-12 md:py-16">
        <div className="flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
          <div>
            ...
            <h2 className="mt-4 font-display text-3xl font-semibold leading-tight md:text-4xl">{content.caseStudies.title}</h2>
          </div>
          <p className="max-w-xl text-[15px] leading-8 text-slate-500 dark:text-slate-300">
        ...
        <div className="mt-8 grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          {content.caseStudies.items.map((item, index) => (
            <div
              key={index}
              className="group flex h-full flex-col overflow-hidden rounded-[1.6rem] border border-white/10 bg-[linear-gradient(180deg,rgba(15,23,42,0.92),rgba(9,16,32,0.96))] shadow-[0_20px_50px_rgba(2,6,23,0.18)] transition-all duration-300 hover:-translate-y-1 hover:border-cyan-300/20 hover:shadow-[0_28px_68px_rgba(8,145,178,0.14)]"
            >
              <div className="relative h-32 bg-gradient-to-br from-slate-900 via-slate-800 to-slate-700 p-6 text-white">
                ...
                <div className="relative z-10">
                  ...
                  <p className="mt-3 font-display text-2xl font-semibold">{item.outcomeValue}</p>
                </div>
              </div>
              <div className="flex h-full flex-col gap-4 p-6">
                <div>
                  <h3 className="font-display text-lg font-semibold text-white">{item.title}</h3>
                  <p className="mt-2 text-[15px] leading-7 text-slate-300/88">{item.description}</p>
                </div>
                <div className="mt-auto flex items-center justify-between border-t border-white/10 pt-4 text-xs font-semibold uppercase tracking-[0.2em] text-slate-400">
                  {item.outcomeLabel}
          ...
          <div className="mt-10 border-t border-slate-200 pt-8 dark:border-white/10">
            ...
            <div className="mt-6 grid gap-4 md:grid-cols-3">
              {industries.map((industry, index) => (
                <div
                  key={index}
                  className="rounded-[1.4rem] border border-white/10 bg-white/[0.04] p-6 text-sm text-slate-300/88"
                >
                  <p className="font-display text-base font-semibold text-white">{industry.title}</p>
      ...
      <div className="container-width py-12 md:py-16">
        <div className="grid gap-8 lg:grid-cols-[0.9fr_1.1fr] items-center">
          ...
          <div>
            ...
            <h2 className="mt-4 font-display text-3xl font-semibold md:text-4xl">{content.founder.name}</h2>
            <p className="mt-2 text-sm text-slate-500 dark:text-slate-400">{content.founder.role}</p>
            <p className="mt-4 text-[15px] leading-8 text-slate-600 dark:text-slate-300">{content.founder.bio}</p>
    ...
    <section className="relative overflow-hidden bg-slate-950 text-white">
      ...
      <div className="container-width relative z-10 py-12 md:py-16">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <h2 className="mt-4 font-display text-3xl font-semibold leading-[1.02] md:text-5xl">{content.ctaBottom.title}</h2>
          <p className="mt-4 text-[15px] leading-8 text-slate-300/90 md:text-[1.05rem]">{content.ctaBottom.subtitle}</p>

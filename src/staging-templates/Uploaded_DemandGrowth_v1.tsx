            ...
            <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-8">
              <div className="w-full lg:w-[52%]">
                <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
                  <div className="text-gradient font-heading text-[11px] font-semibold uppercase tracking-[0.2em] mb-6 inline-block">
                  ...
                  <div className="flex flex-col sm:flex-row gap-4">
                    <Link 
                      ...
                      className="h-12 px-8 bg-cobalt hover:bg-azure text-white font-heading font-bold text-[15px] rounded-lg transition-colors flex items-center justify-center gap-2"
                    >
                      {content.hero.primaryButtonText} <ArrowRight className="w-4 h-4" />
                    </Link>
                    <Link 
              ...
              <div className="w-full lg:w-[48%]">
                ...
                >
                  ...
                  <Image
                    ...
                    className="object-cover opacity-30 mix-blend-overlay relative z-0"
                    priority
                  />
                </motion.div>
              </div>
        ...
        <section className="bg-[#0D2137] py-24 min-h-[560px]">
          <div className="max-w-[1200px] mx-auto px-6 md:px-16">
            <h2 className="font-heading font-bold text-4xl md:text-[48px] text-center mb-16">
              <span className="text-white">{content.funnel.titleLine1}</span>
              <span className="text-gradient">{content.funnel.titleLine2}</span>
            </h2>
        ...
        <section className="bg-white py-24 min-h-[480px]">
          <div className="max-w-[1200px] mx-auto px-6 md:px-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-10 md:gap-0 relative">
              ...
              {content.scale.columns.map((col, idx) => {
                ...
                return (
                  <div key={idx} className={`md:p${idx === 0 ? 'r' : idx === 1 ? 'x' : 'l'}-10`}>
                    ...
                    <div className="font-heading font-bold text-[32px] text-gradient mb-2">{col.value}</div>
        ...
        <section className="relative bg-[#112B3C] py-24 min-h-[320px] overflow-hidden flex items-center">
          ...
          <div className="max-w-[1200px] mx-auto px-6 md:px-16 relative z-10 text-center flex flex-col items-center w-full">
            <h2 className="font-heading font-bold text-4xl md:text-[40px] mb-6">
              <span className="text-white">{content.cta.titleLine1}</span>
              <span className="text-gradient">{content.cta.titleLine2}</span>
            </h2>
            <p className="font-sans text-base text-white/60 max-w-[560px] mb-10">
              {content.cta.description}
            </p>
            <Link 
              href={content.cta.primaryButtonHref}
            ...
            >
              {content.cta.primaryButtonText} <ArrowRight className="w-4 h-4" />
            </Link>
            <Link 
              href={content.cta.secondaryLinkHref}
              className="font-sans text-[14px] text-ice-blue hover:text-white transition-colors flex items-center gap-1"
            >
              {content.cta.secondaryLinkText} <ArrowRight className="w-4 h-4" />
            </Link>
          </div>
        </section>
      </main>

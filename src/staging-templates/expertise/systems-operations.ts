export const SYSTEMS_OPERATIONS_CONTENT = {
  ...
  hero: {
    headline: "Engineer Your Future: Systems & Operations for Unstoppable Growth.",
    subheadline: "Transform operational complexities into strategic advantages, driving efficiency, agility, and profitability across your enterprise.",
    description: "In today's dynamic market, optimized systems and operations are not just about efficiency—they are the bedrock of sustainable growth and competitive resilience. We partner with you to build adaptive frameworks that anticipate change, eliminate bottlenecks, and empower your organization to scale with confidence.",

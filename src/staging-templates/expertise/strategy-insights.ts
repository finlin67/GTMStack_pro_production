export const STRATEGY_INSIGHTS_CONTENT = {
  ...
  hero: {
    headline: "Strategic Insights: Unlocking Your Business's Full Potential",
    subheadline: "Translate complex data into clear, actionable strategies that drive measurable growth and sustainable competitive advantage.",
    description: "Our expertise in Strategy & Insights goes beyond traditional analysis. We synthesize disparate data sources, apply behavioral economics, and identify hidden patterns to deliver predictive insights. This empowers you to make informed decisions, anticipate market shifts, and develop innovative solutions.",

export const EXPERTISE_CONTENT = {
  brand: {
    tagline: "Mastering Go-To-Market for Unrivaled Growth.",
    description: "GTMStack.pro empowers B2B SaaS companies to achieve scalable, predictable revenue through expert Go-To-Market strategy, execution, and optimization."
  },
  hero: {
  ...
  metricsSection: {
    headline: "Quantifiable Impact. Proven Results.",
    stats: [
      { label: "Average Revenue Growth", value: "35%+" },
      { label: "GTM Efficiency Improvement", value: "20%+" },
      { label: "Market Share Expansion", value: "15%+" }
    ]
  },
  capabilitiesSection: {
    headline: "Our Core Areas of Expertise",
    items: [
  ...
  philosophySection: {
    ...
    principles: [
      { title: "Data-Driven Decisions", description: "Every strategy, every tactic, is informed by rigorous data analysis and measurable outcomes, ensuring precision and accountability." },
      { title: "Holistic Approach", description: "We view GTM as an interconnected ecosystem, optimizing all facets—from product to sales to customer success—for synergistic impact." },
      { title: "Sustainable Growth", description: "Our focus extends beyond immediate gains, building resilient GTM frameworks that deliver predictable, long-term revenue and market leadership." },
      { title: "Client-Centric Partnership", description: "We embed ourselves as an extension of your team, aligning our expertise with your vision to achieve shared success." }
    ]
  },
  growthSection: {
    headline: "Engineering Predictable Growth",
    narrative: "At GTMStack.pro, we don't just advise; we architect and implement Go-To-Market systems designed for scalable, repeatable success. Our methodology integrates strategic planning with agile execution, ensuring that every GTM initiative is optimized for maximum impact. We transform market potential into tangible revenue, empowering your organization to achieve and sustain leadership in competitive landscapes.",
    metrics: [
      { label: "Client Retention Rate", value: "90%+" },
      { label: "Average Deal Velocity Improvement", value: "18%" }
    ]
  },
  ctaSection: {

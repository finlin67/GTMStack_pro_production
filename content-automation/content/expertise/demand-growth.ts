export const DEMAND_GROWTH_CONTENT = {
  ...
  hero: {
    headline: "Strategic Demand & Growth: Accelerate Your Revenue Engine",
    subheadline: "Shift from lead volume to high-potential account acquisition and maximize your ROI.",
    description: "Our approach to Demand & Growth transcends traditional lead generation. We specialize in identifying, qualifying, and nurturing the accounts most likely to convert into long-term, high-value customers. By prioritizing quality over quantity and aligning demand efforts with sales objectives, we build a sustainable competitive advantage for your business.",
    ...
    image: { src: "/images/demand-growth-hero.jpg", alt: "Strategic Demand & Growth Dashboard" },
  },
  metricsSection: {

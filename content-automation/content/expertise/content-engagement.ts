export const CONTENT_ENGAGEMENT_CONTENT = {
  ...
  hero: {
    headline: "Elevate Customer Relationships with Strategic Content & Engagement.",
    subheadline: "Move beyond broadcasting to orchestrate holistic engagement strategies that guide customers through defined journeys, fostering meaningful interactions at every touchpoint.",
    description: "We help B2B companies develop and execute a comprehensive content and engagement strategy that drives meaningful interactions, builds brand loyalty, and accelerates revenue growth. Our approach is customer-centric, data-driven, and leverages integrated automation to optimize every touchpoint.",
